...
// Normaliza um item de dia: string vira bullet; objeto respeita {text,type}
function normItem(it) {
  if (typeof it === "string") return { type: "bullet", text: it };
  return { type: it.type || "bullet", text: it.text || "" };
}
